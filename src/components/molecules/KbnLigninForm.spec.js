                ...
                describe('required', () => {
                    describe('何も入力されていない', () => {
                        it('validation.email.requiredがinvalidであること', () => {
                            ...
                            expect(
                                loginForm.vm.validation.email.required
                            ).to.equal(false);
                        });
                    });

                    describe('入力あり', () => {
                        describe('validation.email.formatがinvalidであること', () => {
                ...
                describe('format', () => {
                    describe('メールアドレス形式でないフォーマット', () => {
                        it('validation.email.formatがinvalidであること', () => {
                            ...
                            expect(
                                loginForm.vm.validation.email.format
                            ).to.equal(false);
                        });
                    });
